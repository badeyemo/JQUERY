/* Now that you have learned a bit of jQuery,   
 it's time to refactor an application from vanilla JS
 to use jQuery! You can reuse an application that you 
 have built previously, like the Todo application. */
